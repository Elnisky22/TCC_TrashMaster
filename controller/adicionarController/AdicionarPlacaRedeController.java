...
/**
 * Classe controladora da tela AdicionarPlacaRede.
 * @author Leonardo Elnisky.
 */
public class AdicionarPlacaRedeController {
    ...
    @FXML private JFXCheckBox cbWifi;
    ...
    public void limparCampos() {
    	tfMarca.clear(); tfModelo.clear(); cbWifi.setSelected(false); cbDesconhecido.setSelected(false);
    }
    ...
    /**
     * Método para checar se o CheckBox Wifi foi marcado.
     * @return true se sim, false se não.
     */
    public Boolean getWifi() {
    	return (cbWifi.isSelected()) ? true : false;
    }
}
